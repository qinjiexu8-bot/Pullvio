...
const pages = [
  ...
  "/guides/save-youtube-videos",
  "/guides/save-tiktok-videos",
  "/guides/mp4-vs-mp3",
  "/guides/video-resolution-guide",
  "/guides/save-online-media-legally",
  "/blog/how-online-video-downloaders-work",
  "/blog/why-4k-video-needs-separate-audio",
  "/blog/online-vs-desktop-video-downloader",
  "/blog/mp4-vs-webm-video-format",
  "/privacy",
  "/terms",
  "/copyright",
  "/acceptable-use",
