...
export const policyPages: Record<string, PolicyPage> = {
  about: {
    ...
    body: <>
      ...
      <p>Pullvio works directly in mobile and desktop browsers, helping users save media they own or have permission to use as MP4 video or MP3 audio. Free and Pro plans support occasional and frequent workflows.</p>
  ...
  privacy: {
    ...
    body: <>
      ...
      <ul><li><strong>Basic access data:</strong> hosting and security providers may process IP address, browser type, requested URL, timestamps, and diagnostic information needed to deliver and protect the service.</li><li><strong>Processing data:</strong> submitted source URLs, requested format and quality, job status, and limited technical logs may be used to complete a request and investigate failures.</li><li><strong>Local preferences:</strong> theme and language preferences may be stored in your browser using local storage.</li><li><strong>Account data:</strong> the authentication provider may process your email address, account identifier, session tokens, and login method.</li><li><strong>Billing data:</strong> payment providers process payment details; Pullvio receives subscription status, invoices, and limited transaction records rather than full card details.</li><li><strong>Messages you send:</strong> if you contact Pullvio, we receive the address and content you choose to provide.</li></ul>
      ...
      <p>The service may rely on hosting, media-processing, storage, authentication, payment, email, security, and analytics providers. These providers process data only for the services they supply to Pullvio.</p>
      <h2>Retention and requests</h2>
      <p>Temporary processing files are retained only as long as reasonably needed to complete and deliver a job, then deleted automatically. Security, billing, and support records may be kept longer where needed for fraud prevention, accounting, dispute handling, or legal obligations. You may request access, correction, or deletion by emailing <a href="mailto:privacy@pullvio.com">privacy@pullvio.com</a>, subject to applicable law and necessary records.</p>
    </>,
  },
  terms: {
    eyebrow: "TERMS",
    title: "Terms of use.",
    description: "These terms govern access to Pullvio, its media-processing tools, accounts, published guides, and paid plans.",
    body: <>
      <h2>Service availability</h2>
      <p>Pullvio provides online media-processing tools, account features, educational content, and Free and Pro plans. Availability, supported sources, formats, limits, and pricing may change as the service evolves.</p>
      <h2>Permitted use</h2>
      ...
      <h2>Accounts and future paid plans</h2>
      <p>You are responsible for maintaining account security. Subscription price, billing interval, included limits, renewal terms, and applicable cancellation or refund information are shown before purchase.</p>
      <h2>Contact</h2>
