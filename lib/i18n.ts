...
export const localizedContent = {
  "zh-cn": {
    ...
    faqs: [
      ...
      ["Pullvio 支持哪些网站和链接？", "当前支持 YouTube、Instagram、Facebook、TikTok、Vimeo、Pinterest、Twitch Clips、Dailymotion、Streamable、Snapchat Spotlight 与公开 Story、OK.ru、Imgur、Loom 和 Dropbox 的单个公开媒体链接，以及 SoundCloud 公开音轨。私人内容、播放列表、付费墙、DRM、登录后内容和直播无法处理。"],
  ...
  es: {
    ...
    faqs: [
      ...
      ["¿Qué sitios y enlaces admite Pullvio?", "Admite enlaces públicos individuales de YouTube, Instagram, Facebook, TikTok, Vimeo, Pinterest, Twitch Clips, Dailymotion, Streamable, Snapchat Spotlight y Stories públicas, OK.ru, Imgur, Loom y Dropbox, además de pistas públicas de SoundCloud. No procesa contenido privado, listas, DRM, pagos, sesiones ni directos."],
