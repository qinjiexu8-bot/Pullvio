...
export const localizedContent = {
  "zh-cn": {
    ...
    faqs: [
      ...
      ["Pullvio 支持哪些网站和链接？", "当前提供 YouTube 与 TikTok 公开媒体链接的专用工具页。私人内容、付费墙、DRM、登录后内容、仍在进行的直播或已下架内容可能无法处理。"],
  ...
  es: {
    ...
    faqs: [
      ...
      ["¿Qué sitios y enlaces admite Pullvio?", "Actualmente ofrecemos herramientas específicas para enlaces públicos de YouTube y TikTok. El contenido privado, con DRM, tras un inicio de sesión, de pago, en directo o retirado puede no estar disponible."],
