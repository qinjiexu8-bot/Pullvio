...
export const localizedContent = {
  "zh-cn": {
    ...
    faqs: [
      ...
      ["Pullvio 支持哪些网站和链接？", "当前支持 TikTok、Vimeo、Pinterest、Twitch Clips、Dailymotion、Streamable、Snapchat Spotlight、Imgur、Loom 与 Dropbox 的单个公开媒体链接，以及 SoundCloud 公开音轨。私人内容、播放列表、付费墙、DRM、登录后内容和直播无法处理。"],
  ...
  es: {
    ...
    faqs: [
      ...
      ["¿Qué sitios y enlaces admite Pullvio?", "Admite enlaces públicos individuales de TikTok, Vimeo, Pinterest, Twitch Clips, Dailymotion, Streamable, Snapchat Spotlight, Imgur, Loom y Dropbox, además de pistas públicas de SoundCloud. No procesa contenido privado, listas, DRM, pagos, sesiones ni directos."],
