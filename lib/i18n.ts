...
export const localizedContent = {
  "zh-cn": {
    ...
    heroCopy:
      "支持 YouTube、TikTok、Instagram、Facebook、Snapchat 和 OK.ru 的公开链接。YouTube 可选择 MP4 或 MP3，其他平台提供来源视频。无需登录可完成 5 次下载；登录免费账号后可在合理使用范围内继续下载。",
    ...
    features: [
      ["默认保护隐私", "下载结果通过临时链接交付，请在可用期间尽快保存到您的设备。"],
    ...
    faqs: [
      ...
      ["Pullvio 支持哪些网站和链接？", "当前支持 YouTube、Instagram、Facebook、TikTok、Snapchat 和 OK.ru 的单个公开媒体链接。私人内容、播放列表、付费墙、DRM、登录后内容和直播无法处理。"],
      ["可以下载哪些格式和画质？", "YouTube 可选择 MP4 画质或 MP3 音频；其他支持的平台提供来源视频。可用画质取决于原始媒体；YouTube 来源确实提供时可以选择 2K 或 4K。"],
      ["为什么有时看不到 2K 或 4K？", "Pullvio 不会凭空放大画质。如果原始上传、当前链接或来源平台没有提供对应分辨率，该选项就不会出现。"],
      ["可以只提取视频中的音频吗？", "YouTube 链接可以切换到音频模式生成 MP3，适合保存您有权使用的访谈、课程、播客或原创音乐内容。"],
      ...
      ["Pullvio 会保存我的链接或文件吗？", "下载结果通过临时链接交付，请在可用期间尽快保存。账号历史用于帮助您管理已提交的来源链接与尚未过期的结果；具体范围和保留规则以隐私政策为准。"],
  ...
  es: {
    ...
    heroCopy:
      "Compatible con enlaces públicos de YouTube, TikTok, Instagram, Facebook, Snapchat y OK.ru. YouTube permite elegir MP4 o MP3; las demás plataformas ofrecen el video disponible en la fuente. Haz cinco descargas sin iniciar sesión o crea una cuenta gratuita para continuar dentro de un uso razonable.",
    ...
    features: [
      ["Privado por defecto", "El resultado se entrega mediante un enlace temporal; guárdalo en tu dispositivo mientras siga disponible."],
    ...
    faqs: [
      ...
      ["¿Qué sitios y enlaces admite Pullvio?", "Admite enlaces públicos individuales de YouTube, Instagram, Facebook, TikTok, Snapchat y OK.ru. No procesa contenido privado, listas, DRM, pagos, sesiones ni directos."],
      ["¿Qué formatos y calidades puedo descargar?", "YouTube permite elegir calidad MP4 o audio MP3; las demás plataformas ofrecen el video disponible en la fuente. La calidad depende del original y 2K o 4K solo aparecen para YouTube cuando están realmente disponibles."],
      ...
      ["¿Puedo descargar solo el audio?", "Los enlaces de YouTube permiten cambiar al modo Audio para crear un MP3 de entrevistas, clases, pódcasts o música propia que tengas derecho a guardar."],
      ...
      ["¿Pullvio conserva mis enlaces o archivos?", "El resultado se entrega mediante un enlace temporal, por lo que debes guardarlo mientras siga disponible. El historial ayuda a gestionar enlaces y resultados aún vigentes; consulta la Política de privacidad para conocer el alcance y la conservación."],
...
export const homeContent = {
  en: {
    ...
    heroCopy: "Works with public links from YouTube, TikTok, Instagram, Facebook, Snapchat, and OK.ru. Choose MP4 or MP3 for YouTube; other supported platforms provide the available source video. Complete five downloads without signing in, or create a free account to continue within fair-use limits.",
    ...
    features: [["Temporary delivery", "Completed results use temporary provider links, so save the file to your device while it remains available."], ["Original quality up to 4K", "When a YouTube source offers genuine 2K or 4K quality, Pullvio shows that available resolution."], ["Clear format choices", "Choose MP4 or MP3 for YouTube; other supported platforms provide source video without extensions or confusing format codes."]],
    ...
    faqs: [["Is Pullvio free to use?", "Yes. You can complete five downloads without signing in. A free account has no fixed download cap, but fair-use, security, and source-availability limits still apply."], ["Which sites and links does Pullvio support?", "Pullvio supports single public media links from YouTube, Instagram, Facebook, TikTok, Snapchat, and OK.ru. It does not process private media, playlists, paywalls, DRM, login-only sources, or live content."], ["Which formats and video qualities can I download?", "YouTube supports a selected MP4 quality or MP3 audio. Other supported platforms provide the available source video. Available quality depends on the source; 2K or 4K appears only when YouTube and the original upload genuinely provide it."], ["Why is 2K or 4K sometimes unavailable?", "Pullvio does not artificially upscale media. If the original upload, current link, or source platform does not provide that resolution, the option will not appear."], ["Can I download audio only?", "Audio mode is available for YouTube links. Use it only for interviews, lessons, podcasts, or original music you have the right to save."], ["Is there a video length limit?", "Availability depends on the source, file size, and current service capacity. Very long or large files take longer and may trigger fair-use limits."], ["Can I process several links at once?", "The current workflow processes one link at a time so you can confirm the source, format, and result clearly. Submit the next link after the first finishes."], ["Do I need an account?", "Not for the first five downloads. A free account lets you continue within fair-use limits and manage recent links and account preferences."], ["Does Pullvio work on mobile, and where are files saved?", "Yes, with no app or browser extension required. Use a modern iPhone, Android, Mac, or Windows browser; files normally appear in your browser downloads or device Downloads folder."], ["Why did a link fail or take longer than expected?", "Common causes include a non-public link, regional or age restrictions, an unfinished livestream, removed content, or temporary source limits. Media length, quality, and current demand also affect processing time."], ["Does Pullvio keep my links or files?", "The provider result is temporary, so save completed files promptly. Account history helps you manage submitted source links while results remain available; see the Privacy Policy for the exact scope and retention rules."], ["Is it legal to download online media with Pullvio?", "That depends on the content, its license, the source platform's terms, and local law. Only save your own work, public-domain or openly licensed media, or content you have permission or another legal right to keep. Pullvio is not intended to bypass DRM or access controls."]],
