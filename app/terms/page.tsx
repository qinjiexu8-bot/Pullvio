...
export default function Page() { return <ContentPage {...page} updated="July 17, 2026" links={[["Acceptable use", "/acceptable-use"], ["Copyright policy", "/copyright"]]}>{page.body}</ContentPage>; }
